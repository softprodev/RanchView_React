...
const FaqSection = ({ headingLevel, className, sectionTitle, sectionDesc}) => {
  ...
  return (
    <>
      <div className="relative w-full pt-[30%] md:pt-[20%] lg:pt-[18%] pt-10" >
        ...
        <div className="container relative top-[-90px] md:top-[-150px] lg:top-[-180px] xl:top-[-200px]">
            <header className="mx-auto mb-14 text-center md:mb-20 md:max-w-[720px]">
              ...
              <ButtonContactSolid className="font-body font-semibold text-white text-[1rem] leading-[1.5rem]" modal="modal-contact" altStyle={1} text="Contact Us" />
            </header>
        </div>
      </div>
    </>
