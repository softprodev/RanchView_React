  ...
  return (
    ...
    >
      <div className="container">
        <div
          className={`grid grid-cols-1 items-center gap-y-8 md:grid-cols-12 md:gap-x-10 lg:gap-x-20 ${
            minHeight && minHeight
          }`}
        >
          ...
          <div className={`image-wrapper -mx-4 h-full md:mx-0`}>
            {hasContainer ? (
              <GatsbyImage image={image} alt="" loading="lazy" />
            ) : (
              <div
                className={`h-[75vw] md:absolute md:top-0 md:h-full md:w-[50vw]`}
              >
